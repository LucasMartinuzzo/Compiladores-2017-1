...
arith_expr:
   arith_expr PLUS arith_expr //Lembrar de perguntar o porquê de se usar arith-op → + | - | * | / dá shift/reduce conflict,
|  arith_expr MINUS arith_expr // mas colocar manualmente cada operação não dá.
